        ...
        val MIGRATION_12_13 = object : Migration(12, 13) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    val nombreCategoria = com.example.finance_code.ui.transaction.CategorySuggester.suggestCategory(descripcion) ?: "Otros"
        ...
        fun getDatabase(context: Context, email: String): AppDB {
            ...
            return INSTANCE?.let {
                ...
                val instance = Room.databaseBuilder(
                    ...
                    .addMigrations(MIGRATION_8_10, MIGRATION_9_10, MIGRATION_10_11, MIGRATION_11_12, MIGRATION_12_13, MIGRATION_13_14)
